...
parser.add_argument('--dataset', default='drugData/drug_drug', type=str, help='define your own dataset names')
parser.add_argument("--bert_name", default='pretrain_models/bert_wwm', type=str, help='choose pretrained bert name')
