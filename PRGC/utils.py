...
class Params:
    ...
    def __init__(self, ex_index=1, corpus_type='NYT'):
        ...
        self.data_dir = self.root_path / f'data/drugData/{corpus_type}'
        self.ex_dir = self.root_path / f'experiments/ex{ex_index}'
        self.model_dir = self.root_path / f'model/ex{ex_index}'
        self.bert_model_dir = self.root_path / 'pretrain_models/bert_wwm'
        ...
        # load label2id
        self.rel2idx = json.load(open(self.data_dir/'label.json', 'r', encoding='utf-8'))[-1]
